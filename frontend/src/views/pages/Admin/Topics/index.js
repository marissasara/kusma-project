...
const Topics = () => {
    ...
    const url = process.env.REACT_APP_API_URL + '/admin/topics'; // API server
    ...
    useEffect( () => 
        {
            ...
            .then( response => { // response block
                ...
                store.setValue('topics', response.data.topics ?  response.data.topics : null) // to be used in DataTableComponent
