...
const Deejays = () => {
    ...
    const url = process.env.REACT_APP_API_URL + '/admin/deejays'; // API server
    ...
    useEffect( () => 
        {
            ...
            .then( response => { // response block
                ...
                store.setValue('deejays', response.data.deejays ?  response.data.deejays : null) // to be used in DataTableComponent
